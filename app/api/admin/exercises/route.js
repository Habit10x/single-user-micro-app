...
export async function POST(req) {
  ...
  const [exercise] = await sql`
    INSERT INTO exercises (title, description, timer_minutes, tags, show_default_tags, slug, algorithm_id)
    VALUES (${body.title}, ${body.description || ""}, ${body.timer_minutes || 5}, ${body.tags || ""}, ${body.show_default_tags !== false}, ${slug}, ${sharp?.id || null})
    RETURNING *
  `;
